...
public class HexadecimalSudokuTest {
  ...
  public static void main(String[] arg) {
    ...
    System.out.println("Number of empty cells in example1: " + ex1Count);
    System.out.println("Number of empty cells in example2: " + ex2Count);
    System.out.println("Number of empty cells in example3: " + ex3Count);
    System.out.println("Number of empty cells in example4: " + ex4Count);
